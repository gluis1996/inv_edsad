    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="contenedor_tarjetas_eoc" id="dashboard_eoc">
                </div>    
                ...
                <div class="card ">
                    <div class="row" style="margin-right: 5%; margin-left: 5%;">
                        <div class="col-lg-4 col-xs-10">
                            ...
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">Abonad</label>
                                <div class="col-sm-10">
...
<div id="modal_estado_instalacion_eoc" class="modal fade" role="dialog">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        ...
                        <table class="table table-bordered table-striped dt-responsive" id="tbl_raddact_estado_instalacion_eoc" width="100%">
                            <thead>
                                <tr>
                                    <th>IP Address</th>
                                    <th>Start Time</th>
